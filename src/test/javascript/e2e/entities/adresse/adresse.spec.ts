...
describe('Adresse e2e test', () => {
  ...
  it('should load Adresses', async () => {
    ...
    expect(await adresseComponentsPage.getTitle()).to.eq('locationApp.adresse.home.title');
  ...
  it('should load create Adresse page', async () => {
    ...
    expect(await adresseUpdatePage.getPageTitle()).to.eq('locationApp.adresse.home.createOrEditLabel');
  ...
  it('should delete last Adresse', async () => {
    ...
    expect(await adresseDeleteDialog.getDialogTitle()).to.eq('locationApp.adresse.delete.question');
