...
describe('Logement e2e test', () => {
  ...
  it('should load Logements', async () => {
    ...
    expect(await logementComponentsPage.getTitle()).to.eq('locationApp.logement.home.title');
  ...
  it('should load create Logement page', async () => {
    ...
    expect(await logementUpdatePage.getPageTitle()).to.eq('locationApp.logement.home.createOrEditLabel');
  ...
  it('should create and save Logements', async () => {
    ...
    await promise.all([
      ...
      logementUpdatePage.paiementSelectLastOption(),
    ]);
  ...
  it('should delete last Logement', async () => {
    ...
    expect(await logementDeleteDialog.getDialogTitle()).to.eq('locationApp.logement.delete.question');
