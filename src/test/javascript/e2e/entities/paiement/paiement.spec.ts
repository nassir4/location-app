...
describe('Paiement e2e test', () => {
  ...
  it('should load Paiements', async () => {
    ...
    expect(await paiementComponentsPage.getTitle()).to.eq('locationApp.paiement.home.title');
  ...
  it('should load create Paiement page', async () => {
    ...
    expect(await paiementUpdatePage.getPageTitle()).to.eq('locationApp.paiement.home.createOrEditLabel');
  ...
  it('should delete last Paiement', async () => {
    ...
    expect(await paiementDeleteDialog.getDialogTitle()).to.eq('locationApp.paiement.delete.question');
